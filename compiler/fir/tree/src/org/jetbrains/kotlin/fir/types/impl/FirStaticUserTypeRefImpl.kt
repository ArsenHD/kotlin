...
class FirStaticUserTypeRefImpl(
    ...
    override fun <D> transformChildren(transformer: FirTransformer<D>, data: D): FirStaticUserTypeRefImpl {
        for (part in qualifier) {
    ...
    override fun <D> transformAnnotations(transformer: FirTransformer<D>, data: D): FirStaticUserTypeRef {
        annotations.transformInplace(transformer, data)
        return this
    }

    override fun replaceAnnotations(newAnnotations: List<FirAnnotation>) {
        throw AssertionError("Mutating annotations for FirStaticUserTypeRefImpl is not supported")
    }
}
