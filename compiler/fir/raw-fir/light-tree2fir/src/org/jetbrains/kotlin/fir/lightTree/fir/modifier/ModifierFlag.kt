...
enum class ModifierFlag(val value: Long) {
    ...
    CLASS_FUN(1L shl 6),
    OBJECT_STATIC(1L shl 7),
    MEMBER_OVERRIDE(1L shl 8),
    MEMBER_LATEINIT(1L shl 9),
    VISIBILITY_PUBLIC(1L shl 10),
    VISIBILITY_PRIVATE(1L shl 11),
    VISIBILITY_INTERNAL(1L shl 12),
    VISIBILITY_PROTECTED(1L shl 13),
    VISIBILITY_UNKNOWN(1L shl 14),
    FUNCTION_TAILREC(1L shl 15),
    FUNCTION_OPERATOR(1L shl 16),
    FUNCTION_INFIX(1L shl 17),
    FUNCTION_INLINE(1L shl 18),
    FUNCTION_EXTERNAL(1L shl 19),
    FUNCTION_SUSPEND(1L shl 20),
    PROPERTY_CONST(1L shl 21),
    INHERITANCE_ABSTRACT(1L shl 22),
    INHERITANCE_FINAL(1L shl 23),
    INHERITANCE_OPEN(1L shl 24),
    INHERITANCE_SEALED(1L shl 25),
    PARAMETER_VARARG(1L shl 26),
    PARAMETER_NOINLINE(1L shl 27),
    PARAMETER_CROSSINLINE(1L shl 28),
    PARAMETER_CONST(1L shl 29),
    PLATFORM_EXPECT(1L shl 30),
    PLATFORM_ACTUAL(1L shl 31),
    PLATFORM_HEADER(1L shl 32),
    PLATFORM_IMPL(1L shl 33),
    VARIANCE_IN(1L shl 34),
    VARIANCE_OUT(1L shl 35),
    VARIANCE_INVARIANT(1L shl 36),
    REIFICATION_REIFIED(1L shl 37);
